          ...
          <div className="flex flex-col items-center justify-center py-20 h-full">
            ...
            <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
              ...
              <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                From tools to hostels to transportation, find what you need,
                when you need it, with seamless rentals at your fingertips.
              </p>
              <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                ...
                >
                  ...
                  <a
                    href="https://drive.google.com/file/d/166XLP3xKsQ8JneS-3DL-vXPJq50hqF2t/view?usp=drive_link"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="rounded-full hidden lg:flex border border-foreground/20 px-4 py-2 text-sm"
                  >
                    Download App
      ...
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            ...
            <p className="text-muted-foreground mt-6">
              Kiraye offers a range of features to help you rent your items with
              ease
            </p>
          </div>
        </Container>
          ...
          <LampContainer>
            <div className="flex flex-col items-center justify-center relative w-full text-center">
              ...
              <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                Rent apps seamlessly with Kiraye&apos;s interative and easy to
                use application
              </p>
              <Button variant="white" className="mt-6" asChild>
                <Link href="https://drive.google.com/file/d/166XLP3xKsQ8JneS-3DL-vXPJq50hqF2t/view?usp=drive_link">
                  Download now
